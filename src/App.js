...
import Contextapilang from './Contextapilang';
import ReqresCreate from './ReqresCreate';
import ReqresDelete from './ReqresDelete';
import ReqresUpdate from './ReqresUpdate';
    ...
    return (
     ...
     <Router>
        <Routes>
            ...
            <Route path="/contextapilang" element={<Contextapilang/>}></Route>
            <Route path="/reqrescreate" element={<ReqresCreate/>}></Route>
            <Route path="/reqresupdate" element={<ReqresUpdate/>}></Route>
            <Route path="/reqresdelete" element={<ReqresDelete/>}></Route>
            <Route path="/lazyloading" element={<Applazyloading/>}></Route>
        </Routes>
        </Router>
      </>
    );
